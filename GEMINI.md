...
14. **Plugin Isolation** — Plugins must remain isolated. They should NEVER import directly from core feature slices (e.g., `src/features/analytics`). Shared UI components needed by both core features and plugins must live in `src/shared/components`.
